...
_G.packer_plugins = {
  ...
  ["flash.nvim"] = {
    loaded = true,
    path = "/Users/jingouyang/.local/share/nvim/site/pack/packer/start/flash.nvim",
    url = "git@github.com:folke/flash.nvim"
  },
  ["formatter.nvim"] = {
    loaded = true,
  ...
  ["nvim-nio"] = {
    loaded = true,
    path = "/Users/jingouyang/.local/share/nvim/site/pack/packer/start/nvim-nio",
